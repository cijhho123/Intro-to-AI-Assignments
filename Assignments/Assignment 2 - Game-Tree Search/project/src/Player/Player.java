...
public abstract class Player {
       ...
       private boolean isSearchAgent;     //not for stupid players or  Loyalty players

       private List<Package> packages;
       

       private int busyTime; //how many units of time untill the player arrive at destination (0 = free)
       ...
       public abstract int evaulatePlayer();
}
