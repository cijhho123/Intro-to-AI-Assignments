...
public class DefaultValues {
    static final int VERTICES = 10;                    //1000
    ...
    static final double EDGE_PROBABILITY_DENSE = 0.04;
    ...
    static final int EDGE_WEIGHT_UPPER_BOUND = 100;

    static final int PACKAGES_COUNT_VERY_LOW = 10;
    static final int PACKAGES_COUNT_LOW = 20;
    static final int PACKAGES_COUNT_MEDIUM = 80;                
    static final int PACKAGES_COUNT_HIGH = 200;

    static final int PACKAGES_DEPLOY_TIME_LOWER_BOUND = 0;
    static final int PACKAGES_DEPLOY_TIME_UPPER_BOUND = 5000;

    static final int PACKAGES_DELIVERY_TIME_LOWER_BOUND = 15;   
    static final int PACKAGES_DELIVERY_TIME_UPPER_BOUND = 600000; //2000
    
    static final int HUMAN_PLAYERS_COUNT = 0;
    static final int STUPID_GREEDY_PLAYERS_COUNT = 2;
    static final int INTERFERING_PLAYERS_COUNT = 1;     

    static final int GREEDY_AGENT_COUNT = 1;

    static final int A_STAR_AGENT_COUNT = 1;
    static final int A_STAR_LIMIT_LOWER_BOUND = 2000;
    static final int A_STAR_LIMIT_UPPER_BOUND = 15000;

    static final int REAL_TIME_A_STAR_AGENT_COUNT = 1;
    static final int REAL_TIME_A_STAR_LOWER_BOUND = 5;
    static final int REAL_TIME_A_STAR_UPPER_BOUND = 20;
}
