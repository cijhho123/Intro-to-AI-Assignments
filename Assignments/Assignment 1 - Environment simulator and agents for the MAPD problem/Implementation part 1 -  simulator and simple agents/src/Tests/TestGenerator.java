...
public class TestGenerator {
    ...
    private static void useDefaults() throws IOException{
        ...
        writeEdges(DefaultValues.VERTICES, DefaultValues.EDGE_PROBABILITY_MEDIUM, DefaultValues.EDGE_WEIGHT_LOWER_BOUND, 
            DefaultValues.EDGE_WEIGHT_UPPER_BOUND);
        writeNewLine();

        writePackages(DefaultValues.VERTICES, DefaultValues.PACKAGES_COUNT_MEDIUM, DefaultValues.PACKAGES_DEPLOY_TIME_LOWER_BOUND,
        ...
        writeBlockedEdges(DefaultValues.VERTICES, DefaultValues.FRAGILE_EDGE_PROBABILITY_MEDIUM);
        writeNewLine();

        writeFragileEdges(DefaultValues.VERTICES, DefaultValues.FRAGILE_EDGE_PROBABILITY_MEDIUM);
        writeNewLine();

        writeGreedyAgents(DefaultValues.VERTICES, DefaultValues.GREEDY_PLAYERS_COUNT);
        writeNewLine();
